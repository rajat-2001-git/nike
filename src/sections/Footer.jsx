    ...
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
            Get shoes redy for the new term at your nearest Nike store. Find your perfect size in store. Get Rewards
          </p>
      ...
      <div className="flex justify-between mt-24 max-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
          <img src={copyrightSign} alt="copysright" width={20} height={20} className="rounded-full m-0"/>
          <p className="text-white-400">Copyright. All right reserved.</p>
        </div>
        <p className="text-white-400 font-montserrat cursor-pointer">Terms & Conditions</p>
      </div>
    </footer>
  )
}
